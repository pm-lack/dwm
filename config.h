...
/* static char *fonts[]          = { "monospace:size=11", "Jetbrains Mono NerdFont:pixelsize=11:style=Bold:antialias=true:autohint=true"  }; */
static char *fonts[]		 = { "CaskaydiaMonoNerdFont-Bold:size=10.6:antialias=true:autohint=true"  };
static char dmenufont[]		 = { "CaskaydiaMonoNerdFont-Bold:size=10.6:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_u,          setlayout,              {.v = &layouts[2]} }, /* dwindle */
	...
	{ MODKEY,			XK_F1,         spawn,                  SHCMD("groff -mom /usr/local/share/dwm/pm-larbs.mom -Tpdf | zathura -") },
	...
	{ 0, XF86XK_ScreenSaver,                       spawn,                  SHCMD("slock & xset dpms force off; pauseallmpv") },
